...
class TestAnnotationExtractor(unittest.TestCase):
    ...
    def test_read_ipr(self):
        iprs = read_ipr(self.ipr_file)
        self.assertEquals(3, len(iprs["m.98281"]))
        self.assertEquals(iprs["m.98281"][0], ["Dbxref", "SUPERFAMILY:SSF48726"])
        self.assertEquals(iprs["m.98281"][1], ["Dbxref", "ProSiteProfiles:PS50835"])
        self.assertEquals(iprs["m.98281"][2], ["Dbxref", "ProSiteProfiles:PS50835"])
